#Списочные вложения!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!:
#1)if len ([i for i in val if int(i,15)>9])>=2:
#2)if  [1 for i in val if int(i,15)>9].count('1')>=2:
#3)if sum([1 for i in val if int(i,15)>9])>=2:
#4)if sum[val.count[i] for i in printable[10, 15]]
#------------------------------------------------------------------------------
